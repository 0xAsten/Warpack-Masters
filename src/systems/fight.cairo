    ...
    impl FightImpl of IFight<ContractState> {
        ...
        loop {
            ...
            loop {
                ...
                (item_data_at_j.cooldown == item_data_at_j_plus_one.cooldown && item_data_at_j.energyCost > item_data_at_j_plus_one.energyCost) 
                {
                    ...
                    if rand < chance {
                        if curr_item_belongs == 'player' {
                            ...
                            if damage > 0 {
                                ...
                                let vampirism_heal = if char_vampirism < damageCaused { char_vampirism } else { damageCaused };
                                ...
                                if curr_item_data.itemType == 1 && dummy_reflect > 0 {
                                    ...
                                    // Vampirism: Restore health based on damage dealt
                                    let vampirism_heal = if dummy_vampirism < damageCaused { dummy_vampirism } else { damageCaused };
