...
trait IActions {
    ...
    fn prefine_dummy(level: usize, name: felt252, wmClass: WMClass, items: Array<PredefinedItem>);
    fn update_prefine_dummy(dummyCharId: usize, level: usize, name: felt252, wmClass: WMClass, items: Array<PredefinedItem>);
}
